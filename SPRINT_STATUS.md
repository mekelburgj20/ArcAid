...
- **Current version:** **v2.8.2** — deployed to production 2026-04-28.
- **Most recent arc (v2.8.0 → v2.8.2 — identity merge forward-attribution + Discord-style display names):**
...
- **Build state:** backend `tsc` clean, admin-ui `vite build` clean, **129/129 tests pass**. SW `CACHE_NAME` → `arcaid-v40`.
