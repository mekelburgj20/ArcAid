...
- **Current version:** **v2.7.1** — deployed to production 2026-04-26.
- **Most recent arc (v2.7.1 — tournament platform-rules orthogonality, ADR 0009):**
...
- **Build state:** backend `tsc` clean, admin-ui `vite build` clean. SW `CACHE_NAME` → `arcaid-v34`.
