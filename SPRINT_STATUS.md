...
- **Most recent arc (v2.8.0 — identity merge forward-attribution + Discord-style display names):**
  ...
  - **Docs.** CHANGELOG v2.8.0 entry. SW `CACHE_NAME` → `arcaid-v38`.
- **Build state:** backend `tsc` clean, admin-ui `vite build` clean, **129/129 tests pass**.
