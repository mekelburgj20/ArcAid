...
- **Current version:** **v2.7.0** — deployed to production 2026-04-27.
- **Most recent arc (v2.7.0 — per-room tags + new importers + tournament rules shift):**
...
- **Build state:** backend `tsc` clean, admin-ui `vite build` clean, **109/109 tests pass**. Last verified end of v2.7.0 deploy. SW `CACHE_NAME` → `arcaid-v33`.
