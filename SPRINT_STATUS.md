...
- **Current version:** **v2.6.0** — deployed to production 2026-04-26.
- **Most recent arc (v2.6.0 — step-2 cleanup):**
  - **v2.6.0** — **Drop legacy `game_library` table + complete the library=catalogue arc.** Plan: `docs/step-2-cleanup-plan.md`. 7 sequential commits (2c → 2a → 2b → 2g → 2d → 2f → 2e), each independently buildable.
