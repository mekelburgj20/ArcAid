...
- **Lazy images** — `loading="lazy" decoding="async"` on every in-card/grid image (wheel icons, style headers, card art, avatars, YouTube thumbs); header logos and detail-page heroes stay eager.
