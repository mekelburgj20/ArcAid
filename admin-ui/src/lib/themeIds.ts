/**
 * Theme identity — FRONTEND copy.
 *
 * Mirrored BYTE-IDENTICALLY below this header in `src/utils/themeIds.ts`
 * (backend), locked by `src/__tests__/themeIds-parity.test.ts`. Same contract
 * as the `scoreProvenance.ts` pair: extend, never fork. The module is
 * deliberately dependency-free so the two copies can be literally identical.
 */
