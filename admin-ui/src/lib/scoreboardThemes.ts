...
const glassDeck: ShowcaseThemeConfig = {
  ...
  podiumGold: {
    bg: 'linear-gradient(135deg, rgba(255,215,0,0.45), rgba(255,215,0,0.20))',
  ...
  podiumSilver: {
    bg: 'linear-gradient(135deg, rgba(192,192,192,0.38), rgba(192,192,192,0.15))',
  ...
  podiumBronze: {
    bg: 'linear-gradient(135deg, rgba(205,127,50,0.38), rgba(205,127,50,0.15))',
  ...
  rowZebraStripe: 'rgba(255,255,255,0.12)',
  rankColor: 'rgba(255,255,255,0.7)',
  nameColor: 'rgba(255,255,255,0.95)',
  scoreColor: 'rgba(255,255,255,0.90)',
  avatarBg: 'rgba(255,255,255,0.22)',
  avatarColor: 'rgba(255,255,255,0.7)',
...
const neonCircuit: ShowcaseThemeConfig = {
  ...
  rowZebraStripe: 'rgba(120,0,255,0.18)',
  rowHoverBorder: 'rgba(255,0,200,0.35)',
  rankColor: 'rgba(255,255,255,0.75)',
  nameColor: 'rgba(255,255,255,0.95)',
  scoreColor: 'rgba(255,255,255,0.90)',
  avatarBg: 'rgba(120,0,255,0.30)',
  avatarBorder: '1px solid rgba(120,0,255,0.45)',
  avatarColor: 'rgba(255,255,255,0.8)',
