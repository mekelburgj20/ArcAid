...
const glassDeck: ShowcaseThemeConfig = {
  ...
  podiumGold: {
    bg: 'linear-gradient(135deg, rgba(255,215,0,0.28), rgba(255,215,0,0.10))',
  ...
  podiumSilver: {
    bg: 'linear-gradient(135deg, rgba(192,192,192,0.22), rgba(192,192,192,0.08))',
  ...
  podiumBronze: {
    bg: 'linear-gradient(135deg, rgba(205,127,50,0.22), rgba(205,127,50,0.08))',
  ...
  rowZebraStripe: 'rgba(255,255,255,0.07)',
  rankColor: 'rgba(255,255,255,0.6)',
  nameColor: 'rgba(255,255,255,0.90)',
  scoreColor: 'rgba(255,255,255,0.80)',
...
const neonCircuit: ShowcaseThemeConfig = {
  ...
  rowZebraStripe: 'rgba(120,0,255,0.10)',
  rowHoverBorder: 'rgba(255,0,200,0.35)',
  rankColor: 'rgba(255,255,255,0.65)',
  nameColor: 'rgba(255,255,255,0.90)',
  scoreColor: 'rgba(255,255,255,0.80)',
  avatarBg: 'rgba(120,0,255,0.20)',
  avatarBorder: '1px solid rgba(120,0,255,0.35)',
