...
const glassDeck: ShowcaseThemeConfig = {
  ...
  badgeColor: '#63d297',
  timerColor: 'rgba(255,255,255,0.2)',
  ...
  rowZebraStripe: 'rgba(255,255,255,0.015)',
  ...
  linkColor: 'rgba(99,210,151,0.65)',
  metaColor: 'rgba(255,255,255,0.12)',
};
...
const neonCircuit: ShowcaseThemeConfig = {
  ...
  badgeColor: '#c77dff',
  timerColor: 'rgba(255,255,255,0.25)',
  ...
  podiumSilver: {
    ...
    scoreColor: 'rgba(255,255,255,0.4)',
    rankColor: '#c0c0c0',
  },
  podiumBronze: {
    bg: 'transparent',
    border: 'none',
    textColor: 'rgba(255,255,255,0.55)',
    scoreColor: 'rgba(255,255,255,0.35)',
    rankColor: '#cd7f32',
  },

  rowZebraStripe: 'rgba(120,0,255,0.025)',
  rowHoverBorder: 'rgba(255,0,200,0.25)',
  rankColor: 'rgba(255,255,255,0.25)',
  nameColor: 'rgba(255,255,255,0.6)',
  scoreColor: 'rgba(255,255,255,0.35)',
  avatarBg: 'rgba(120,0,255,0.06)',
  avatarBorder: '1px solid rgba(120,0,255,0.12)',
  avatarColor: 'rgba(255,255,255,0.35)',

  footerBorder: 'rgba(120,0,255,0.12)',
  linkColor: '#c77dff',
