...
const MOBILE_PREFS: PrefDef[] = [
  ...
  { key: 'SCOREBOARD_MOBILE_SCALE', label: 'Mobile Scale Factor', description: 'Scale cards on mobile (0.3-1.0). Default 0.6 = 60% of desktop size.', type: 'number', min: 0.3, max: 1.0, step: 0.1 },
];
